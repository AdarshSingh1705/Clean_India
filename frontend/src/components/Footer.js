          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <ul>
                ...
                <li><a href="https://www.instagram.com/adarshsingh_1705/"><i className="fab fa-instagram"></i>  instagram</a> </li>
                <li><a href="https://x.com/AdarshSingh1705"><i className="fab fa-twitter"></i>  x</a> </li>
              </ul>
            </div>
          </div>
        </div>
